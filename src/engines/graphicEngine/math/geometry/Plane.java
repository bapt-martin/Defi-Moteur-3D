...
public class Plane {
    ...
    public int clipTriangleAgainstPlane(Triangle triIn, List<Triangle> trisOut) {
        ...
        if (nbPointsInside == 1) {
            ...
            trisOut.add(new Triangle(vertsOut1, textVertsOut1, triIn.getLightIntensities(), triIn.getColor(), texture));
//            trisOut.add(new Triangle(vertsOut1, textVertsOut1, Color.RED, texture));
        ...
        if (nbPointsInside == 2) {
            ...
            trisOut.add(new Triangle(vertsOut1, textVertsOut1, triIn.getLightIntensities(), triIn.getColor(), texture));
            trisOut.add(new Triangle(vertsOut2, textVertsOut2, triIn.getLightIntensities(), triIn.getColor(), texture));
